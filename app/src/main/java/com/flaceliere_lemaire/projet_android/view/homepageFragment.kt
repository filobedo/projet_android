...
class homepageFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val navHost = childFragmentManager.findFragmentById(R.id.fragmentContent) as NavHostFragment
        NavigationUI.setupWithNavController(home_menu, navHost.navController)
